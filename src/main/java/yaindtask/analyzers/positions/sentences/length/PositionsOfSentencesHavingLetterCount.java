...
public class PositionsOfSentencesHavingLetterCount implements Analyzer {

  private final SentenceTokenizer sentenceTokenizer;
  private final int letterCount;

  public PositionsOfSentencesHavingLetterCount(int letterCount) {
    this(new ManualSentenceTokenizer(), letterCount);
  }

  public PositionsOfSentencesHavingLetterCount(SentenceTokenizer sentenceTokenizer,
      int letterCount) {
